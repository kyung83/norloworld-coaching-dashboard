export default function Badge({ text, onClick }) {
  return(
    <span className="inline-flex items-center gap-x-0.5 rounded-md bg-gray-200 px-4 py-2 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10">
      {text}
